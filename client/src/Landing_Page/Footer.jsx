      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <motion.div className="col-span-1 md:col-span-1" variants={itemVariants}>
            ...
            <p className="mt-4 text-gray-400 text-sm">
              A vibrant community of student coders learning, building, and growing together.
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <motion.p className="text-center text-gray-400 text-sm" variants={itemVariants}>
            &copy; {currentYear} CodeCommunity. All rights reserved.
          </motion.p>
          <motion.p className="text-center text-gray-500 text-xs mt-2" variants={itemVariants}>
